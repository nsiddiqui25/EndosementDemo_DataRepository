...
{
    public partial class PLD_PRODUCTIONContext : DbContext
    {
        public PLD_PRODUCTIONContext()
        {
        }

        public PLD_PRODUCTIONContext(DbContextOptions<PLD_PRODUCTIONContext> options)
            : base(options)
        {
        }
